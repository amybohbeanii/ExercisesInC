...
I started to worked on exercise 2.5 and 3, but the documentation is confusing for me, so I need to read more about regex and tee. I actually have already completed reading the HFC book before the semester started, but with the workload, have been struggling with completing these exercises during the semester.
